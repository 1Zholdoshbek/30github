<h2> 1090 171
1718. Construct the Lexicographically Largest Valid Sequence</h2><hr><div><p>Given an integer <code>n</code>, find a sequence with elements in the range <code>[1, n]</code> that satisfies all of the following:</p>
